...
public class InfoMember extends Pages implements Initializable, AutoInitialize {
    @FXML private Button back_menu_btn;
    ...
    @FXML private Button edit_info_btn;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        vaccine_edit_cbb.setItems(FXCollections.observableArrayList("1","2","3","4","5","6","7","8"));
    ...
    public void goBackMenuInfo(ActionEvent event) throws IOException{
        Main m = new Main();
        Menu menu = new Menu();
